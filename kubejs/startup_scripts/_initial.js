...
Platform.mods.kubejs.name = "Polytech"
...
global.unificationPattern = new RegExp(`^(?!(${global.UnificationExcludedItems.join('|')})|).*?(mekanism|tfmg|railcraft|nuclearcraft|thermal|enderio|ad_astra):(powdered_.*|.*(_block|_plate|_ingot|_nugget|_gear|_dust|_rod|_wire))`, 'i');
